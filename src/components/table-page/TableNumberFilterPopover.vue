...
<template>
  <div
    ref="rootRef"
    class="w-[252px] max-w-[calc(100vw-2rem)] rounded-xl bg-popover p-2.5 shadow-[var(--shadow-card)]"
    data-list-popover
  >
    <div class="flex items-center justify-between gap-2">
      ...
      <div class="relative shrink-0" data-list-popover>
        ...
        <div
          v-if="openActionMenu"
          class="absolute left-[calc(100%+6px)] top-1/2 z-40 min-w-[104px] -translate-y-1/2 rounded-md bg-popover p-1 shadow-[var(--shadow-card)]"
          data-list-popover
        >
          <button
            type="button"
