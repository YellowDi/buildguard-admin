...
<template>
  ...
  >
    <TooltipWrap content="打开侧边栏">
      <button
        type="button"
        class="-ml-1 inline-flex size-7 shrink-0 items-center justify-center rounded-md text-foreground transition-[background-color,color,transform] duration-180 ease-out hover:bg-accent hover:text-accent-foreground active:scale-[0.96] motion-reduce:active:scale-100 min-[1000px]:hidden"
        aria-label="打开侧边栏"
    ...
    <TooltipWrap content="切换侧边栏">
      <button
        type="button"
        class="-ml-1 hidden size-7 shrink-0 items-center justify-center rounded-md text-foreground transition-[background-color,color,transform] duration-180 ease-out hover:bg-accent hover:text-accent-foreground active:scale-[0.96] motion-reduce:active:scale-100 min-[1000px]:inline-flex"
        aria-label="切换侧边栏"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger as-child>
              <TooltipWrap content="展开面包屑">
                <button
                  type="button"
                  class="inline-flex size-8 items-center justify-center rounded-md text-muted-foreground transition-[background-color,color,transform] duration-180 ease-out hover:bg-accent hover:text-accent-foreground active:scale-[0.96] motion-reduce:active:scale-100"
                  aria-label="展开面包屑"
                >
                  <BreadcrumbEllipsis class="size-8" />
                </button>
              </TooltipWrap>
            </DropdownMenuTrigger>
