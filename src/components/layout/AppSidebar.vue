...
function isBusinessRoute(path: string) {
  return ["/", "/customers", "/parks", "/buildings", "/monitoring", "/inspection-services", "/inspection-plans", "/media-library", "/customer-projects", "/app-home", "/customer-feedback", "/work-orders"].some(
